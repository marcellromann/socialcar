...
import { formatCep, formatPhone, onlyDigits, summarizeBuyer } from '@/lib/format';
      ...
      <div className="page-pad space-y-4">
        ...
        <section className="card p-4">
          <header className="mb-3">
            <h2 className="display text-sm text-brand-500">Meus dados</h2>
          </header>
          ...
          {saveMsg && <p className="mt-2 text-center text-[11px] text-slate-300">{saveMsg}</p>}
        </section>

        {/* Minhas preferências */}
        <section className="card p-4">
          <header className="flex items-center justify-between">
            <h2 className="display text-sm text-brand-500">Minhas preferências</h2>
